...
% Draw rectangle
img = insertShape(img,'Rectangle',positions(logical(state.pos), :),'LineWidth',6, 'Color', 'red', 'Opacity', 1);
% Show the image
imshow(img)

...
function [] = MI2_Preprocess_Scaffolding(recordingFolder)
...
%% Visuallize
% data = permute(MIData, [3 2 1]);
% idle_idx = find(trainingVec == 7);
% left_idx = find(trainingVec == 6);
% right_idx = find(trainingVec == 2);

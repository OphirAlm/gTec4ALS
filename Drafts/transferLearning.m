function lgraph = transferLearning(inputSz, outputSz)

lgraph = layerGraph();
inputSz = [inputSz, 1];

tempLayers = [
    imageInputLayer(inputSz,"Name","imageinput")
    convolution2dLayer([7 7],64,"Name","conv","BiasLearnRateFactor",2,"Padding",[3 3 3 3],"Stride",[2 2])
...
tempLayers = [
    ...
    fullyConnectedLayer(outputSz,"Name","fc")
